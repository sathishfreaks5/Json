...
use Json\Databucket\Exceptions\InvalidNodeException;
use Json\Databucket\Exceptions\NullValueException;
...
class Databucket {
      ...
      public function __construct($jsonFile = null)
    {
      ...
      if (!is_null($jsonFile)) {
        ...
        */
         $this->custom_import($jsonFile);
    }

    public static function saySomething() {
        return 'Data Bucket Package is Working!';
    }
