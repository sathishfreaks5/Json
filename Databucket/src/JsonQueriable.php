...
namespace Json\Databucket;

use Json\Databucket\Exceptions\ConditionNotAllowedException;
use Json\Databucket\Exceptions\FileNotFoundException;
use Json\Databucket\Exceptions\InvalidJsonException;
use Json\Databucket\Results\ValueNotFound;
use Json\Databucket\Condition;
...
trait JsonQueriable
{
     ...
     * @return $this
     */
      public function whereCoalesce($key = null, $value = [])
    {
        $this->where($key, 'ifnull', $value);
